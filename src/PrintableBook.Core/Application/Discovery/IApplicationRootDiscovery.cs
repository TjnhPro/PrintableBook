...
public sealed record DiscoveredBrandAssetEntry(string Name, string Extension, ImageSize? Size, string Status);
public sealed record DiscoveredBrandAsset(string Name, string Type, string Status, string Path, string Extension = "", ImageSize? Size = null, IReadOnlyList<DiscoveredBrandAssetEntry>? Entries = null);
