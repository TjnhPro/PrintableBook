  ...
  window.chrome.webview.addEventListener("message", (event) => {
    ...
    if (ok && command === "updates.state") {
      ...
      if (preserveBookDrawer) {
        ...
        refreshBookCatalogCards(catalogCommand);
