(() => {
  ...
  content.addEventListener("input", (event) => {
    ...
    if (event.target.dataset.action === "filter-brands") { state.brandFilter = event.target.value; render("brands", false); }
