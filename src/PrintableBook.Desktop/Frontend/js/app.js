(() => {
  ...
  const setRoute = (route) => {
    ...
    if (route === "books") content.innerHTML += `<section class="panel mt-5"><h2 class="panel-title">Book overview and structure</h2><p class="mt-2 text-sm text-slate-500">Selected Book shows source folders, workspace state and non-destructive actions.</p></section>`;
